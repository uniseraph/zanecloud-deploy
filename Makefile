...
release-withdeps:
	...
	mkdir -p release/zanecloud-deploy/binary && \
	    wget http://zanecloud-docker.oss-cn-shanghai.aliyuncs.com/1.11.1/6b802c8/docker-1.11.1   -O release/zanecloud-deploy/binary/docker   && \
        wget http://zanecloud-docker.oss-cn-shanghai.aliyuncs.com/1.11.1/6b802c8/docker-containerd  -P release/zanecloud-deploy/binary  && \
        wget http://zanecloud-docker.oss-cn-shanghai.aliyuncs.com/1.11.1/6b802c8/docker-containerd-ctr  -P release/zanecloud-deploy/binary  && \
        wget http://zanecloud-docker.oss-cn-shanghai.aliyuncs.com/1.11.1/6b802c8/docker-containerd-shim   -P release/zanecloud-deploy/binary  && \
        wget http://zanecloud-docker.oss-cn-shanghai.aliyuncs.com/1.11.1/6b802c8/docker-runc  -P release/zanecloud-deploy/binary && \
